...
<div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a href="clients-login.html" class="btn btn-outline-primary btn-sm px-3 fw-semibold"><i
                            class="feather-user-check me-1"></i> Login Client</a>

                    <a href="clients-inforce.html" class="btn btn-outline-primary btn-sm px-3 fw-semibold"><i
                            class="feather-shield me-1"></i> Inforce</a>
                    <a href="clients-inactive.html" class="btn btn-light btn-sm px-3 fw-semibold"><i
                            class="feather-user-x me-1"></i> Inactive</a>
