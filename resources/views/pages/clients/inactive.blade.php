                    ...
                    <table class="table table-hover align-middle w-100" id="inactiveClientsTable">
                        ...
                        <tbody>
                            ...
                            <tr data-source="Existing Client" data-status="Inactive">
                                ...
                                <td class="fs-13 text-muted">{{ $client->dob ? $client->dob->format('d/m/Y') : 'N/A' }}</td>
                                <td class="fs-13 text-muted">{{ $client->city ?: 'N/A' }}{{ $client->city && $client->zip_code ? ', ' : '' }}{{ $client->zip_code }}</td>
                                <td><span class="status-pill-inactive">Inactive</span></td>
                                <td class="fs-13 text-muted">Login Client</td>
                                <td class="fs-13 fw-semibold text-dark text-center">N/A</td>
                                ...
                                <td class="text-center">
                                    <div class="action-kebab-wrapper">
                                        ...
                                        <div class="action-kebab-dropdown">
                                            <a href="javascript:void(0);" class="action-kebab-item" onclick="viewClientDetails('{{ addslashes($client->first_name . ' ' . $client->last_name) }}', '{{ addslashes($client->phone) }}', '{{ addslashes($client->city) }}', 'Inactive', 'N/A')"><i class="feather-eye text-primary me-1"></i> View Profile</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            @empty
                            <tr><td colspan="9" class="text-center text-muted py-4">No inactive clients found.</td></tr>
                            @endforelse
</tbody>
                    </table>
                </div>
